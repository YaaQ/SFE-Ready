...
## ![qlogo](https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png) **SFESpecSim**
...
- AR(1), phi=0.9
- AR(1), phi=-0.9
- AR(2), phi1=0.9 ; phi2=-0.75
- AR(2), phi1=-0.1 ; phi2=0.5
- MA(1), theta1=0.9
- MA(1), theta1=-0.9
- SAR(1), phi1=0.5, PHI1=0.5
