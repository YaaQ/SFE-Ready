...
## ![qlogo](https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png) **SFEscomCIR**

```yaml
Name of QuantLet : SFEscomCIR Published in: Statistics of Financial Markets Description: Compares
CIR and Vasicek models with the real data. Keywords: - cir - graphical representation -
interest-rate - plot - process - short-rate - simulation - time-series - vasicek See also: -
SFECIRmle - SFEVasiml - SFEcir - SFEcirpricing - SFEsimCIR - SFEsimVasi Author: - Awdesch Melzer -
Li Sun Submitted: Sat, July 25 2015 by quantomas Datafiles: yield_US3month9808.txt Input: - a - a
CIR - b - b CIR - sigma - sigma CIR - a1 - a Vasicek - b1 - b Vasicek - sigma1 - sigma Vasicek
